...
/**
 * <a href="http://balusc.blogspot.be/2011/09/communication-in-jsf-20.html#GettingAnEJBInFacesConverterAndFacesValidator"/>
...
public final class EJB {
    ...
    static {
        try {
            EJB_CONTEXT = "java:global/" + new InitialContext().lookup("java:app/AppName") + "/ejb/";
